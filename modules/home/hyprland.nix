      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          ...
          bind = [
            ...
            "$mod CTRL, H, layoutmsg, swapcol l" # for scrolling
            "$mod CTRL, L, layoutmsg, swapcol r" # for scrolling
            "$mod SHIFT, H, workspace, e-1"
            "$mod SHIFT, L, workspace, e+1"
            "$mod SHIFT CTRL, H, movetoworkspace, r-1"
            "$mod SHIFT CTRL, L, movetoworkspace, r+1"
            "$mod, F, fullscreen, 1"
